...
public class PedigreePage {
    ...
    @FindBy(xpath = "//input[@name='evaluated']")
    public WebElement documentEvaluation;
    ...
    public boolean clickOnDocumentEvaluationOption() {
        try {
            if (Wait.isElementDisplayed(driver, documentEvaluation, 100)) {
                Actions.clickElement(driver, documentEvaluation);
