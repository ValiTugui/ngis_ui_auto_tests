...
Feature: Patient search page
  ...
  @patientSearch_02 @NTS-2817 @E2EUI-831
  ...
  @patientSearch_03 @NTS-2780 @E2EUI-2128 @E2EUI-1109
  ...
  @patientSearch_04 @NTS-2795 @E2EUI-2129  @E2EUI-2136 @E2EUI-1762 @E2EUI-1788
  ...
  @patientSearch_05 @NTS-2822 @E2EUI-2140 @E2EUI-2132 @E2EUI-2131
...
#       | E2EUI-2132   | NHS Spine2           | DOB=07-03-1977:FirstName=Gillian:LastName=Ohern:Gender=Female  | Defects NTOS-4169
  ...
  @patientSearch_08 @NTS-2781 @E2EUI-1188 @E2EUI-1481
  ...
  @patientSearch_09 @NTS-2789 @E2EUI-1304 @E2EUI-904  @E2EUI-827
  ...
  @patientSearch_10 @NTS-2802 @E2EUI-827 @E2EUI-1294
  ...
  @patientSearch_11 @NTS-2789 @E2EUI-1304
  ...
  @patientSearch_12 @NTS-2800 @E2EUI-1211
  ...
  @patientSearch_15 @NTS-2797 @E2EUI-2161
  ...
  @patientSearch_16 @NTS-2799 @E2EUI-1390
  ...
  @patientSearch_17 @NTS-2801 @E2EUI-1114
  ...
  @patientSearch_18 @NTS-2801 @E2EUI-1114  @E2EUI-1840  @E2EUI-2163
  ...
  @patientSearch_19 @NTS-2801 @E2EUI-1840
  ...
  @patientSearch_22 @NTS-2797 @E2EUI-2161
  Scenario Outline:NTS-2797:"<patient-search-type>" - User can search for a different patient after successful alternative search
    And the user clicks the NO button
    When the user types in valid details "<SearchDetails>" of a "<patient-search-type>" patient in the No of Fields
    And the user clicks the Search button
  ...
  @patientSearch_23 @NTS-2799 @E2EUI-1390
  Scenario: NTS-2799:To verify the text information present on the 'Find a Patient' page
    Then the display title of the page is "Find your patient"
    And the display description title contains the phrase "Add any information you have to search the NHS Spine and the Genomics England database (NGIS)"


  @patientSearch_24 @NTS-2816 @E2EUI-1990
  ...
  @patientSearch_25 @NTS-2816 @E2EUI-1990
  Scenario: NTS-2816:To verify auto-complete and auto-fill are disabled on the patient search page without NHS Number field
    ...
    @patientSearch_26 @NTS-3050 @E2EUI-968 @E2EUI-1308
  ...
  @patientSearch_27 @NTS-3050 @E2EUI-968 @E2EUI-1308
