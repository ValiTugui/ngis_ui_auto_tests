...
Feature: Patient search page
  ...
  @patientSearch_03 @E2EUI-2128 @E2EUI-1109
  ...
  @patientSearch_04 @E2EUI-2129  @E2EUI-2136 @E2EUI-1762 @E2EUI-1788
  ...
  @patientSearch_05 @E2EUI-2140 @E2EUI-2132 @E2EUI-2131
...
#       | E2EUI-2132   | NHS Spine2           | DOB=07-03-1977:FirstName=Gillian:LastName=Ohern:Gender=Female  | Defects NTOS-4169
  ...
  @patientSearch_08 @E2EUI-1188 @E2EUI-1481
  ...
  @patientSearch_09 @E2EUI-1304 @E2EUI-904  @E2EUI-827
  ...
  @patientSearch_10 @E2EUI-827 @E2EUI-1294
  ...
  @patientSearch_18 @E2EUI-1114  @E2EUI-1840  @E2EUI-2163
  ...
  @patientSearch_20 @E2EUI-1182 @E2EUI-926
  Scenario Outline: Verifying the Patient Details page after successful search for "<patient-search-type>" patient
    When the user types in valid details of a "<patient-search-type>" patient in the NHS number "<NhsNumber>" and Date of Birth "<DOB>" fields
    And the user clicks the Search button
    Then a "<patient-search-type>" result is successfully returned
  ...
  @patientSearch_23 @E2EUI-1390
  Scenario: To verify the text information present on the 'Find a Patient' page
    Then the display title of the page is "Find your patient"
    And the display description title contains the phrase "Add any information you have to search the NHS Spine and the Genomics England database (NGIS)"


  @patientSearch_24  @E2EU-1990
