...
#   #Responsible Clinician - Update
    ...
    Examples:
      | patientDetails  | requestingOrganisation  | testPackage  | responsibleClinician  | ResponsibleClinicianDetails                                                         | tumours | samples | notes | patientChoice  | PrintForms  | RequestingOrganisationUpdated            | ResponsibleClinicianDetailsUpdated                                                     | testPackageUpdated | NotesUpdated                      |
      | Patient details | Requesting organisation | Test package | Responsible clinician | FirstName=Samuel:LastName=John:Department=Greenvalley,uk:EmailAddress=msith@test.om | Tumours | Samples | Notes | Patient choice | Print forms | South London and Maudsley NHS Foundation | Department=9144 Timothy Corners:LastName=Delphine:EmailAddress=morris.rippin@yahoo.com | Priority=Urgent    | Chuck Norris doesn't pair program |