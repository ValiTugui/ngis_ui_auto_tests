...
Feature: NTS-3407 - Security scan for RD Duo flow - Create New NGIS Patient Referral for Duo Family - Create Referral for Duo Family + Default Data + Add Family Members to Test + Patient Choice Not Given - Search Non Spine/NGIS Patient
  ...
  Scenario Outline: NTS-3407: User Journey by creating new NGIS Referral for Trio Family - By Signature
    ...
    Examples:
      ...
      | Patient details | Requesting organisation | Maidstone And Tunbridge Wells NHS Trust | Test package | 2                | Responsible clinician | FirstName=Karen:LastName=Smith:Department=Victoria Street | Clinical questions | DiseaseStatus=Affected:AgeOfOnset=10,02:HpoPhenoType=Lymphedema | Notes | Family members | Patient choice | Panels | Pedigree | Print forms |