...
#   Then the user sees a prompt alert "<partOfMessage>" after clicking "submit" button and click on "ReloadReferral" to validate the data
  #   Then the user should be able to view patient details page and data is updated
#    When the user navigates to the "<testPackage>" stage
...
#    Then the user should be able to view Pedigree with updated data
  ...
  ##Pedigree updated by User2
    ...
    Examples:
      ...
      | 2               | FirstName=edward:LastName=thomas:Department=woodspark,uk | DiseaseStatus=Affected:HpoPhenoType=Scrotal hypoplasia:AgeOfOnset:01,01 | ClinicianName=Smith | Optic neuropathy | Notes | Patient details | Requesting organisation | Test package | Responsible clinician | Clinical questions | Notes | Panels | Pedigree | Patient choice | Family members | Other  | Deceased   | B - White - Irish |02,03  |20-10-2010  |
