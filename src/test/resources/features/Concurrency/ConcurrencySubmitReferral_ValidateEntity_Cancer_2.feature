...
##Tumour details updated by User2
    ...
    And the user clicks the Save and Continue button
    Then the user is navigated to a page with title Answer questions about this tumour
    When the user answers the tumour dynamic questions for Tumour Core Data by selecting the tumour presentation "<presentationType_1>"
    And the user clicks the Save and Continue button
    Then the user is navigated to a page with title Select or edit a tumour
    And the success notification is displayed "Tumour added"
    And the user clicks the Save and Continue button
...
##Tumour questions details updated by User2
    ...
    And the user clicks the Save and Continue button
    Then the user is navigated to a page with title Answer questions about this tumour
    When the user answers the tumour dynamic questions for Tumour Core Data by selecting the tumour presentation "<presentationType_2>"
    And the user clicks the Save and Continue button
    Then the user is navigated to a page with title Select or edit a tumour
...
##Samples questions details updated by User2
    ...
    Examples:
      | stage   | PatientDetails  | updated_tumour_type      | Tumours | presentationType_1 | presentationType_2 | sampleType           | sampleState | Samples | pageTitle     |
      | Tumours | Patient details | Solid tumour: metastatic | Tumours | First presentation | Recurrence         | Liquid tumour sample | Fibroblasts | Samples | Edit a sample |
