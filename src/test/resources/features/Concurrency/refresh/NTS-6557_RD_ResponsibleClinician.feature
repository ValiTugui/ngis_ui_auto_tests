...
###FLOW
  ...
  #User3 Updated Responsible clinician stage for the referral
  #User4 Navigated and verify the changes done by user3 in Responsible clinician stage
  ...
  Scenario Outline: Login as User A,Create a New Referral, Complete all stages and do not submit referral,and updated Responsible clinician stage, when B accessed same referral then verified data updated by A.
    ...
    #Responsible clinician - Updated by User3
    ...
    And the user clicks the Save and Continue button
    And the user updates the file NRF1 with Responsible Clinician details Updated by User3
    Examples:
  ...
  Scenario Outline: Verified Responsible clinician stage of new referral updated by another user
    ...
    #Responsible clinician - Verified by User4
    ...
    And the user waits max 10 minutes for the update Responsible Clinician details Updated by User3 in the file NRF1
    When the user navigates to the "<ResponsibleClinician>" stage
    Then the user verifies the stage "<ResponsibleClinician>" with "<ResponsibleClinicianDetailsUpdated>"
    And the user updates the file NRF1 with Responsible Clinician details validated by User4
