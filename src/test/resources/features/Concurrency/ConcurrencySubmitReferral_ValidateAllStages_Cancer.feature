...
## Finally User1 submit Referral Successfully
    ...
    Examples:
      | RequestingOrganisation  | testPackage  | tumour_type           | presentationType | sampleType           | sampleState         | RecordedBy                            |
      | Requesting organisation | Test package | Solid tumour: primary | Recurrence       | Liquid tumour sample | Fresh frozen tumour | ClinicianName=John:HospitalNumber=123 |
...
##Patient Choice updated by User2
    ...
    Examples:
      | PatientDetails  | TestPackage  | Tumours | RequestingOrganisation  | ResponsibleClinicianDetails2                             | ResponsibleClinician  | tumour_type              | presentationType   | sampleType                | sampleState | Samples | Notes | RecordedBy                             | PatientChoiceStage |
      | Patient details | Test package | Tumours | Requesting organisation | FirstName=edward:LastName=thomas:Department=woodspark,uk | Responsible clinician | Solid tumour: metastatic | First presentation | Normal or germline sample | Fibroblasts | Samples | Notes | ClinicianName=Smith:HospitalNumber=123 | Patient choice     |

# |update_patient's_details    |
