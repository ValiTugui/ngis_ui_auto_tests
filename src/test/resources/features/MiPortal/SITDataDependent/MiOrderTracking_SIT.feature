...
Feature: MIPORTAL SIT - Order_Tracking
  ...
  Scenario Outline:NTS-5046:E2EUI-2337: A user should be able to see the column header "gel1001__clinical_indication_test_type_id" in the results section of Order Tracking when filter Clinical Indication Test Type is selected.
    ...
    And the user selects Clinical Indication Test Type as the order tracking search column dropdown
    ...
    Examples:
      ...
      | Order Tracking | is        | Diabetes - neonatal onset WGS: Neonatal diabetes                                                   |
      | Order Tracking | is one of | Diabetes - neonatal onset WGS: Neonatal diabetes,Cerebral malformations WGS: Cerebral malformation |
