...
#    And the mi-portal "<mi_stage>" stage is selected
  ...
  @NTS-5036
   # @E2EUI-2336
  Scenario Outline: NTS-5036: New data columns in the result table of GLH Samples
    When the user navigates to the mi-portal "<mi_stage>" stage
    And the user sees a search box container section for "<mi_stage>" page
 ...
 ###One filter remaining to include in the example,as from E2EUI-2336 The filter "gel1001_dispatched_sample_id" is not present in the search result table.
  ...
  @NTS-5036
   # @E2EUI-2486
  Scenario Outline:NTS-5036: The GLH Samples section is having a new Filename filter
    When the user navigates to the mi-portal "<mi_stage>" stage
    And the user sees a search box container section for "<mi_stage>" page
  ...
  @NTS-5049
    #@E2EUI-1162
  Scenario Outline: NTS-5049 : MI Dashboard | Filter
  ...
  @NTS-5033
    #@E2EUI-2579
  Scenario Outline:E2EUI-2579 MIS - Remove "is one of" option for Gel 1004 GLH Sample Consignment Number Filter in GLH Samples
    Given a web browser is at the mi-portal home page
      | MI_PORTAL_URL | ngis.io | GEL_NORMAL_USER |
    When the user navigates to the mi-portal "<mi_stage>" stage
    And the user sees a search box container section for "<mi_stage>" page
