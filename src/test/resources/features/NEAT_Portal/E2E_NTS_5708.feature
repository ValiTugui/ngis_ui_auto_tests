@NEAT
Feature: RD Proband : NTS-5708: Submit a referral by creating a new patient and inactive the patient by using NEAT and process GEL1001

  @NTS-5708 @Z-LOGOUT
    #E2EUI-2736
  Scenario Outline: NTS-5708: Submit a referral by creating a new patient and inactive the patient by using NEAT and process GEL1001
...
##NEAT
    ...
    ##Once after inactivating the patient, the API is refused to provide the information for the inactivated patient,thus we wont be able to generate the CSV file and verify in MI.
    #The UI flow till inactivating the patient has been automated. The processing of gel 1001 file and verification of the error message in MI has to do manually.
