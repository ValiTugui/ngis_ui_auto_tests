...
#    @E2EUI-2557
  Scenario Outline:NTS-6654:E2EUI-2557:[E2E|UI] - Prevent users from reactivating a patient whose NHS number exists when deep linking to the status page (form)
    ...
    When the user types in valid details of a "<patient-search-type1>" patient in the NHS number "<NhsNumber>" and Date of Birth "<DOB>" fields
    And the user clicks the Search button
    Then a "<patient-search-type1>" result is successfully returned
    ...
    And the user clicks the Search button
    Then a "<patient-search-type2>" result is successfully returned
    And the user clicks the patient result card
    Then the Patient Details page is displayed
...
#      | NGIS                 | 9449306524 | 20-10-2010 | NHS Spine            | p39093451555 |
      | NGIS                 | 9449306613 | 15-02-2009 | NHS Spine            | p39093451555 |
