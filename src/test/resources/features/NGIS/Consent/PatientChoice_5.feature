...
Feature: Patient Choice -5 - Page - FamilyMemberAddition
  ...
  ###Objective of the TC's are:--
  #1 Test status for proband and FM
  #2 FM details verification on PC page
  #3 PC and FM stages marked as completed

##New Merged Scenario
   @Test @NTS-3435 @NTS-3341 @NTS-3450 @Z-LOGOUT
    #@E2EUI-1877
