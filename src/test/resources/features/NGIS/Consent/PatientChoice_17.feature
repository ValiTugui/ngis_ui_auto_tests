#@patientChoice
@05-CONSENT_NotInST
Feature: Patient Choice-17- Document upload section should be open by default
  ...
  Scenario Outline: NTS-6025: Validating removal of incorrectly Uploaded Document functionality in Patient choice section
    ...
    Then the user see that proper message "<expectedMessage>" is displayed after document is deleted
