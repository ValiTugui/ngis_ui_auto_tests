#@UserJourneys
#Feature: Create Referral for Proband Only + Edit Data + Patient Choice No + Tumour + Sample - Search NGIS Patient
#
#
#  @UserJourneys-CANCER @UserJourneys-E2EUI-1636
#  Scenario Outline: E2EUI-1636 - UseCase#21: NGIS Patient -> Create Referral for Proband only -> Patient Choice No -> Tumour -> Sample
#    #Test Directory
...
#    When  the user searches for a NGIS patient record
...
#      | WGS Germline and Tumour | NHS Spine           | 9449309086 | 09-09-2008 | manchester   | Urgent            | No                  |
