...
Feature: Patient Choice Page
  ...
  @COMP9_TO_PatientChoiceAdd
    @PatientChoice_page_22 @LOGOUT @NTS-3418 @E2EUI-1702 @v_1 @P0
  ...
  @COMP9_TO_PatientChoice
    @PatientChoice_page_23 @NTS-3437 @E2EUI-1878 @v_1 @P0 @scenario_01
  Scenario Outline: NTS- :scenario_01: Verify the Supporting information form section in form library
    Given a referral is created with the below details for a newly created patient and associated tests in Test Order System online service
      | TEST_DIRECTORY_PRIVATE_URL | test-selection/clinical-tests | Holoprosencephaly - NOT chromosomal | Rare-Disease | create a new patient record | Patient is a foreign national |
  ...
  @COMP9_TO_PatientChoice
  @PatientChoice_page_24 @LOGOUT @NTS-3437 @E2EUI-1878 @v_1 @P0 @scenario_02
