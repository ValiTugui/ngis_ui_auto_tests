...
#    @E2EUI-2780
  Scenario Outline: NTS-3414: User visits offline order page for form download for Rare Disease
    ...
    Examples:
      | TextToValidate                                                                                                                                                                                          |
      | RARE AND INHERITED,v1.21,Samples (being sent to GLH DNA extraction lab),Blood (EDTA),Amniotic fluid,Fetal blood (EDTA),Chorionic Villus,Fresh Tissue (not tumour),Stored DNA,Sample ID |
