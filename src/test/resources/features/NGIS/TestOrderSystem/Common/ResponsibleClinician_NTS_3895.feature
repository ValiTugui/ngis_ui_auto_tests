...
Feature: Responsible Clinician - Modal Dialog
  ...
  @NTS-3895 @E2EUI-1730 @LOGOUT @Scenario_01
  ...
  @NTS-3895 @E2EUI-1730 @LOGOUT @Scenario_02
  Scenario Outline: NTS-3895:  Modal showing when there are incomplete stages
    Given a new patient referral is created with associated tests in Test Order System online service
  ...
  @NTS-3895 @E2EUI-1730 @LOGOUT @Scenario_03
  Scenario Outline: NTS-3895 :  Modal showing when there are incomplete stages
    Given a new patient referral is created with associated tests in Test Order System online service
  ...
  @NTS-3895 @E2EUI-1730 @LOGOUT @Scenario_04
  Scenario Outline: NTS-3895 :  Modal showing when there are incomplete stages
    Given a new patient referral is created with associated tests in Test Order System online service
