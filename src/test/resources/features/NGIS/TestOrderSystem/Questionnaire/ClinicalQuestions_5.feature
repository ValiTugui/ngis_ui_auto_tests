...
#    @E2EUI-1625 @E2EUI-1068 @E2EUI-842
  Scenario Outline: NTS-3433 - Clinical Questions - Allow HPO terms to be deleted
    ...
    And the Clinical Questions page is displayed with at least "3" HPO terms in the HPO Phenotype section
    Examples:
      | stage              | title                     | hpoTerm1               | hpoTerm2 | hpoTerm3          | partOfMessage                     | removeIcon | acknowledgeMessage | hpoTerm11 | hpoTerm21 | hpoTerm31 |
      | Clinical questions | Answer clinical questions | Aspartylglucosaminuria | Nocturia | Juvenile cataract | Confirm removal of this HPO term. | remove     | Accept             | Sparse    | Anonych   | J         |