...
Feature: Panels
  ...
  @COMP09_Panels
    @TO_COMP9_Panels01 @LOGOUT @E2EUI-1278  @v_1 @P0
...
##    As observed below line is not able to click and perform on save and continue button
#    And the user clicks the Save and Continue button
  ...
  @COMP9_Panels
    @TO_COMP9_Panels02 @LOGOUT @E2EUI-1045  @v_1 @P0
  ...
  @COMP9_TO_Panels
  @COMP9_TO_Panels03 @LOGOUT @E2EUI-1231  @v_1 @P0
  Scenario: E2EUI-1231: User is making a referral, as a user I will see a clear tick on the icon when I select yes or no
    Given a referral is created with the below details for the given existing patient record type and associated tests in Test Order System online service
    ...
    And the user should click on "Incomplete" button and it will be selected
    Then the user is able to see that the selected "Incomplete" button has tick marked
    And the user should click on "Complete" button and it will be selected
    Then the user is able to see that the selected "Complete" button has tick marked