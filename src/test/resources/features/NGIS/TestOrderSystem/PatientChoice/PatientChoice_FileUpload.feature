...
Feature: Patient Choice Page
  ...
  Scenario Outline: NTS-3420 : Verify upload of patient choice paper form with size less than 10Mb
    ...
    Examples:
      | Patient choice stage | PatientChoiceCategory | TestType                        | RecordedBy                                                                                     | FormSuccessMessage    |
      | Patient choice       | Adult (With Capacity) | Rare & inherited diseases – WGS | ClinicianName=John:HospitalNumber=123:Action=UploadDocument:FileType=Record of Discussion Form | Successfully Uploaded |
