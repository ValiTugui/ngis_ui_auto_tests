...
Feature: NTS-4965:Create Referral for Additional Participants
  ...
  @NTS-4965 @Z-LOGOUT
    #@E2EUI-2672
  Scenario Outline: NTS-4965 : Create Referral for Additional Participants (not part of Referral) + Default Data + Patient Choice Yes
   ...
   ##Patient Details
    ...
    Examples:
      ...
      | Patient details | Requesting organisation | Test package | 1              | NHSNumber=NA:DOB=18-07-2015:Gender=Male:Relationship=Full Sibling | DiseaseStatus=Unaffected | Not being tested | Responsible clinician | FirstName=Barack:LastName=Obama:Department=Consulate,uk | Clinical questions | DiseaseStatus=Affected:AgeOfOnset=00,11:HpoPhenoType=Phenotypic abnormality:PhenotypicSex=Male:KaryotypicSex=XY | Notes | Family members    | Patient choice     | ClinicianName=John | Panels | Pedigree | Catar,Crani  | Print forms     |
