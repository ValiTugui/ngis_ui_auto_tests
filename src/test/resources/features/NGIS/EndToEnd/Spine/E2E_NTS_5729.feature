...
#E2EUI-2750
    ...
    Given a new patient referral is created with associated tests in Test Order System online service
      | TEST_DIRECTORY_PRIVATE_URL | test-selection/clinical-tests | M143 | GEL_NORMAL_USER | NHSNumber=9449308721:DOB=16-02-2004|
    ##Patient Details
    ...
    When the user adds "<TwoParticipant>" family members to the proband patient as new family member patient record with below details
      ...
      | NHSNumber=9449308721:DOB=16-02-2004:Relationship=Full Sibling       | Full Sibling               | DiseaseStatus=Unaffected:AgeOfOnset=0,01:HpoPhenoType=Phenotypic abnormality:PhenotypicSex=Female:Karyotypic sex=XY |
    ...
    When the user completes the patient choice for below family members as agreeing to test
      ...
      | NHSNumber=9449308721:DOB=16-02-2004 | Adult (With Capacity) | ClinicianName=John:HospitalNumber=123:Action=UploadDocument:FileType=Record of Discussion Form:FileName=testfile.pdf |
    ...
    And the user is able to download print forms for "1" family members with the below details
      | FamilyMemberDetails                 |
      | NHSNumber=9449308721:DOB=16-02-2004 |
    ###Submitting Referral
