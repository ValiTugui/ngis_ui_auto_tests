...
#    @E2EUI-1348 @E2EUI-1230
    ...
    Examples:
      | FamilyMember   | ProbandDetails              | Disease   | TumourFieldValues | WarningMessage                                                                                | ErrorMessage                                                                                                                                                                   |
      | Family members | NHSNumber=NA:DOB=25-11-1990 | carcinoid | 123abc,234jut     | Save this pedigree before leaving this section. Changes will be lost if details aren’t saved. | Invalid value entered for 'Number Of Colorectal Polyps Total' for Participant with id,Invalid value entered for 'Number of Colorectal Polyps Adenomas' for Participant with id |
...
#    @E2EUI-1345 @E2EUI-1160  @E2EUI-1074
  Scenario Outline: NTS-4796:(E2EUI-1345,1160): Editable Fields for Non NGIS Participants
    ...
    Examples:
      | FamilyMember   | ProbandDetails              | TumourFieldValues | Disease                                                                                       | ErrorMessage                                                                                                                                                                   | WarningMessage                                                                                |
      | Family members | NHSNumber=NA:DOB=25-11-1991 | 123abc,234jut     | carcinoid                                                                                     | Invalid value entered for 'Number Of Colorectal Polyps Total' for Participant with id,Invalid value entered for 'Number of Colorectal Polyps Adenomas' for Participant with id | Save this pedigree before leaving this section. Changes will be lost if details aren’t saved. |
