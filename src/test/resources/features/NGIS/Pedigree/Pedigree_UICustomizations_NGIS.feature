...
#    @E2EUI-1073 @E2EUI-1277
  Scenario Outline: NTS-3388:(E2EUI-1073,1277): UI Customizations: NGIS Patient -  Tumours Tab
    Given a new patient referral is created with associated tests in Test Order System online service
      | TEST_DIRECTORY_PRIVATE_URL | test-selection/clinical-tests | R105 | GEL_NORMAL_USER | NHSNumber=NA-Patient not eligible for NHS number (e.g. foreign national):DOB=25-11-1972:Gender=Male |
    ##Patient Details
    Then the user is navigated to a page with title Add a requesting organisation
    ##Pedigree Stage
    When the user navigates to the "<PedigreeStage>" stage
...
#    @E2EUI-946 @E2EUI-1425
  Scenario Outline: NTS-3464:(E2EUI-946,1425): UI Customizations: NGIS Patient -  Phenotype Tab
    Given a new patient referral is created with associated tests in Test Order System online service
      | TEST_DIRECTORY_PRIVATE_URL | test-selection/clinical-tests | R105 | GEL_NORMAL_USER | NHSNumber=NA-Patient not eligible for NHS number (e.g. foreign national):DOB=25-11-1971:Gender=Male |
    ##Patient Details
    Then the user is navigated to a page with title Add a requesting organisation
    ##Pedigree Stage
    When the user navigates to the "<PedigreeStage>" stage
