...
@07-PEDIGREE
@SYSTEM_TEST
Feature: Pedigree - Diagram Layout 2
...
#    @E2EUI-1373 @E2EUI-836 @E2EUI-1269
  Scenario Outline: NTS-3386:E2EUI-1373,836,1269: Test with a trio (mother & father)
    ...
    ##Below step added ,as sometimes direct clicking on Requesting Organisation from Pedigree is not happening due to some overlay
